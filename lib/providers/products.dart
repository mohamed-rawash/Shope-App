...
class Products with ChangeNotifier{
  ...
  Future<void> fetchAndSetProducts([bool filterByUser = false]) async {
    ...
    var url = "https://shop-4c6d0-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filteredString";
    ...
    try{
      ...
      url = 'https://shop-4c6d0-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken';
  ...
  Future<void> addProduct(Product product) async {
    final url = 'https://shop-4c6d0-default-rtdb.firebaseio.com/products.json?auth=$authToken';
    try{
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if(productIndex >= 0)
    {
     final url = 'https://shop-4c6d0-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken';
     await http.patch(
         url,
         body: json.encode({
